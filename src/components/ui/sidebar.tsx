...
function useSidebar() {
  ...
  if (!context) {
    throw new ConvexError("useSidebar must be used within a SidebarProvider.")
  }
    ...
    <>
      ...
      {isMobile && state === "expanded" && (
        <div
          ...
          className="fixed inset-0 z-10 bg-black/50 animate-in fade-in-0"
      ...
      >
        ...
        <div
          ...
          className={cn(
            ...
            // On mobile collapsed, show icon width; on mobile expanded, show full width with higher z-index
            isMobile && "z-20 group-data-[collapsible=icon]:w-(--sidebar-width-icon)",
