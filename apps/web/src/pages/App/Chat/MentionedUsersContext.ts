...
export const MentionedEventsContext = createContext<Record<string, MentionedEvent>>({});
...
export function useMentionedEvents() {
  return useContext(MentionedEventsContext);
}
